...
public class Game2Fragment4 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        vista= inflater.inflate(R.layout.fragment_game_pass_2, container, false);
        ...
        boton1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (boton1.getText().toString().equals(answer)) {
                    Navigation.findNavController(view).navigate(R.id.action_game2Fragment4_to_game2Fragment5);
                } else {
                    Navigation.findNavController(view).navigate(R.id.action_game2Fragment4_to_game2Fragment8);
                }
            }
        });
