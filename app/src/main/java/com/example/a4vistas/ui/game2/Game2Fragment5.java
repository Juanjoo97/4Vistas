...
public class Game2Fragment5 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        vista= inflater.inflate(R.layout.fragment_game_pass_3, container, false);
        ...
        boton1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (boton1.getText().toString().equals(answer)) {
                    Navigation.findNavController(view).navigate(R.id.action_game2Fragment5_to_game2Fragment6);
                } else {
                    Navigation.findNavController(view).navigate(R.id.action_game2Fragment5_to_game2Fragment8);
                }
            }
        });
